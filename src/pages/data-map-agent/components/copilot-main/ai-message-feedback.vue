  ...
  <div class="ai-message-feedback">
    <div class="ai-message-feedback__actions">
      ...
      <Button
        ...
        @click="onLike"
      >
        <template v-if="!feedbackLoading" #icon><LikeFilled v-if="isLike" /><LikeOutlined v-else /></template>
      </Button>
      <Button
        type="text"
        class="ai-message-feedback__btn"
      ...
      <Button
        type="text"
        class="ai-message-feedback__btn ai-message-feedback__btn--share"
        @click="onShare"
      >
...
import { CopyOutlined, LikeOutlined, LikeFilled, DislikeOutlined, DislikeFilled, CloseCircleFilled, ShareAltOutlined } from '@ant-design/icons-vue';
